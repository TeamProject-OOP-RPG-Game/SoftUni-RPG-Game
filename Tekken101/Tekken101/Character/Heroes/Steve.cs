namespace Tekken101.Characters
{
    ...
    public class Steve : BaseBerserk
    {
        ...
        public Steve(PlayerType playerType, SpriteType type, int X, string initialName, string description, int initialHealth, int initialSpeed, int initialDefense, int initialCriticalChance, int initialStunChance)
