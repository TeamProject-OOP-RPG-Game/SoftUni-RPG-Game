namespace Tekken101.Characters
{
    ...
    public class Lili : BaseAssassin
    {
        ...
        public Lili(PlayerType playerType, SpriteType type, int X, string name, string description, int initialHealth, int initialSpeed, int initialDefense, int initialCriticalChance, int initialLifeSteal)
