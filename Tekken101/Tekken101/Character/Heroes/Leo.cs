namespace Tekken101.Characters
{
    ...
    public class Leo : BaseAssassin
    {
        ...
        public Leo(PlayerType playerType, SpriteType type, int X, string name, string description, int initialHealth, int initialSpeed, int initialDefense, int initialCriticalChance, int initialLifeSteal)
