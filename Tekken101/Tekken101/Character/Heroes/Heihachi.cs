namespace Tekken101.Characters
{
    ...
    public class Heihachi : BaseBerserk
    {
        ...
        public BaseSkill AttackOne
        {
            ...
            set
            {
                this.attackOne = new BaseSkill(SpriteType.PowerBomb, "Power Bomb", DestriptionSkillOne, 55, 50, 70, 200);
            }
        }
        ...
        public BaseSkill AttackTwo
        {
            ...
            set
            {
                this.attackTwo = new BaseSkill(SpriteType.BrokenToy, "Broken Toy", DestriptionSkillTwo, 55, 50, 70, 200);
            }
        }
        ...
        public BaseSkill AttackThree
        {
            ...
            set
            {
                this.attackThree = new BaseSkill(SpriteType.FireStarter, "Fire Starter", DestriptionSkillThree, 55, 50, 70, 200);
            }
        }
        ...
        public BaseSkill AttackFour
        {
            ...
            set
            {
                this.attackFour = new BaseSkill(SpriteType.AtomicDrop, "Atomic Drop", DestriptionSkillFour, 55, 50, 70, 200);
            }
        }
