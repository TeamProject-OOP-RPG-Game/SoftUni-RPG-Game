namespace Tekken101.Characters
{
    ...
    public class Lee : BaseAssassin
    {
        ...
        public Lee(PlayerType playerType, SpriteType type, int X, string name, string description, int initialHealth, int initialSpeed, int initialDefense, int initialCriticalChance, int initialLifeSteal)
